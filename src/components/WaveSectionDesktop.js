...
const FEATURES = [
  { img: '/clock.png', text: '1 daqiqada kerakli manbalarni topish imkoniyati', left: 'calc(6.09% + 1px)', top: '16%', width: 'clamp(170px, 13.5vw, 259px)' },
...
function WaveSectionDesktop({ waveSectionRef, lineCTAPathRef, featureItemsRef }) {
  return (
    <section ref={waveSectionRef} className="py-[60px] pb-20 relative overflow-hidden mobile:hidden bp-sm:hidden bp-xs:hidden">
      <div className="relative h-0 [width:calc(100%+1px)] [-margin-left:1px] [padding-bottom:20.104%]">
        ...
        {FEATURES.map((f, i) => (
          ...
          >
            ...
            <p
              className="font-sf text-[20px] font-normal text-primary leading-normal tracking-[-0.4px] m-0 bp-lg:text-[17px] bp-md:text-[14px]"
