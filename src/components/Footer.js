    ...
    <footer className="bg-primary py-12 px-16 flex flex-col gap-12 mobile:py-8 mobile:px-5 mobile:gap-7">
      <div className="flex items-start gap-0 mobile:flex-wrap mobile:gap-7">
        ...
        <div className="flex-none min-w-[220px] mr-16 mobile:min-w-0 mobile:mr-0 mobile:flex-auto">
          ...
          <div className="font-sf text-[24px] text-bg mb-2 cursor-pointer hover:opacity-70 transition-opacity" onClick={() => alert('Tez kunda!')}>Chizmachilik</div>
          <div className="font-sf text-[24px] text-bg cursor-pointer hover:opacity-70 transition-opacity" onClick={() => alert('Tez kunda!')}>Dizayn</div>
        </div>
